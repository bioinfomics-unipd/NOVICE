...
if len(sys.argv) < 6:
    print('----------------------------------------------')
    print('----------------------------------------------')
    print('CORRECT SYNTAX: NOVICE_1_0.py path/file argument1 argument2 argument3 argument4 argument5 argument6[required only if GC is chosen as option in argument1]')
    print('available options for argument1: rank, PCA, GC, all')
...
print('*******************************************************')
print('>>>>>>>>>>>>>> NOVICE version 1.0.0 <<<<<<<<<<<<<<<<<<<')
print('*******************************************************')
print('>>>>> check our GitHub page! <<<<<')
print('>>>>> Link: https://github.com/bioinfomics-unipd/NOVICE <<<<<')
print('*******************************************************')
          
if sys.argv[2] != 'rank' and sys.argv[2] != 'all' and sys.argv[2] != 'PCA' and sys.argv[2] != 'GC': 
...
if sys.argv[2] == 'GC' or sys.argv[2] == 'all':
    ...
    plt.xticks([])
    plt.legend()
    plt.savefig(str(sys.argv[5])+'GCscatterplot.pdf')
    plt.clf()
